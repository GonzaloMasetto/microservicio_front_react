...
export default function MainMenu() {
  ...
  return (
    <div>
      ...
      <NavLink to="/perfil" className="menu_item btn btn-sm btn-link">Mi perfil</NavLink><br />
      <NavLink to="/sugerencia" className="menu_item btn btn-sm btn-link">Sugeridos</NavLink><br />
